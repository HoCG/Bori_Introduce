<template>
  <div class="corgi-box">
    <div class="corgi">
      <div class="head-of-welsh">
        <div class="ear-of-welsh ear-of-welsh--r"></div>
        <div class="ear-of-welsh ear-of-welsh--l"></div>

        <div class="eye-of-welsh eye-of-welsh--left"></div>
        <div class="eye-of-welsh eye-of-welsh--right"></div>

        <div class="face-of-welsh">
        ...
        <div class="mouth-of-welsh">

          <div class="nose-of-welsh"></div>
